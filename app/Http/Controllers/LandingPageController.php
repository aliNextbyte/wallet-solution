...
class LandingPageController extends Controller
{
    ...
    public function landingPageHome(): \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        $imageSource = [];
        $imageSource['intro_left_image'] = Helpers::onErrorImage($data['intro_section']['data']['intro_left_image'], asset('storage/app/public/landing-page/intro-section') . '/' . $data['intro_section']['data']['intro_left_image'], asset('assets/landing/img/media/ss-1.png'), 'landing-page/intro-section/');
        $imageSource['intro_middle_image'] = Helpers::onErrorImage($data['intro_section']['data']['intro_middle_image'], asset('storage/app/public/landing-page/intro-section') . '/' . $data['intro_section']['data']['intro_middle_image'], asset('assets/landing/img/media/ss-1.png'), 'landing-page/intro-section/');
        $imageSource['intro_right_image'] = Helpers::onErrorImage($data['intro_section']['data']['intro_right_image'], asset('storage/app/public/landing-page/intro-section') . '/' . $data['intro_section']['data']['intro_right_image'], asset('assets/landing/img/media/ss-1.png'), 'landing-page/intro-section/');
