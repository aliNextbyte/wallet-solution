<div id="styleSwitcherDropdown" class="hs-unfold-content sidebar sidebar-bordered sidebar-box-shadow w-35-rem">
    <div class="card card-lg border-0 h-100">
        <div class="card-header align-items-start">
            <div class="mr-2">
                <h3 class="card-header-title">{{translate('Front Builder')}}</h3>
                <p>{{translate('Customize your overview page layout. Choose the one that best fits your needs.')}}</p>
            </div>
        ...
        <div class="card-body sidebar-scrollbar">
            <h4 class="mb-1">{{translate('Layout skins')}}
                <span id="js-builder-disabled" class="badge badge-soft-danger opacity-0">{{translate('Disabled')}}</span>
            </h4>
            <p>{{translate('3 kinds of layout skins to choose from.')}}</p>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Default')}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Light')}}</span>
                        </div>
                    </div>
                </div>
            </div>

            <h4 class="mb-1">{{translate('Sidebar layout options')}}</h4>
            <p>{{translate('Choose between standard navigation sizing, mini or even compact with icons.')}}</p>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Compact')}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Mini')}}</span>
                        </div>
                    </div>
                </div>
            </div>

            <h4 class="mb-1">{{translate('Header layout options')}}</h4>
            <p>{{translate('Choose the primary navigation of your header layout.')}}</p>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Default (Fluid)')}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Default (Container)')}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 text-center">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Double line (Fluid)')}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 text-center mt-2">
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <span class="custom-checkbox-card-text">{{translate('Double line (Container)')}}</span>
                        </div>
                    </div>
                </div>
            </div>
